...
$sql = "UPDATE Productos SET Nombre = '$nombre', Descripcion = '$descripcion', Imagen = IF('$imagen' = '' OR '$imagen' = 'null', Imagen, '$imagen'), Precio = $precio, Existencia = $existencia WHERE Id = $id";
